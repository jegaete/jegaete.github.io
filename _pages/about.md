...
<p>A la fecha cuento con más de <span class="orcid-badge"><span id="orcid-pub-count">95</span> publicaciones</span> en revistas científicas y he dirigido o participado como co-investigador en más de <span class="orcid-badge">{{ site.projects | size }} proyectos</span> de investigación financiados por la Agencia Nacional de Investigación y Desarrollo (ANID) y otras agencias nacionales e internacionales (Wellcome Trust, Academy of Finland, entre otras).</p>
